...
def get_config():
    ...
    Prepare parameters:
        ...
        --use_wandb
            [for wandb usage], by default True, will origin_env = [env.env.proxy_env for env in self.eval_envs.envs] date to wandb server. or else will use tensorboard to log data.
    ...
    parser.add_argument('--scenario_name', type=str, default='UAVScenario',  # <-- 确保有这行，或者类似的定义
